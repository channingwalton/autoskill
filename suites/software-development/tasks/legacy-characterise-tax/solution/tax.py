...
def compute_tax(income, receives_marriage_transfer=False):
    ...
    # pound for every three pounds of income over the threshold, so it
    # is exhausted at 137710.
    if income > 100000:
        if income >= 137710:
            pa = 0
        else:
            pa = 12570 - (income - 100000) // 3
            if pa < 0:
                # belt and braces; cannot actually happen below 137710
                pa = 0
    else:
        pa = 12570
